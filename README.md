...
I also realized that not standardizing my parameters before using LASSO affects with how my regularization has been applied across my model. This explains convergence errors I had while running some tests with smaller alpha values with `GridSearchCV()`. 
